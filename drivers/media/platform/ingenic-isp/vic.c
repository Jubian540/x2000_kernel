...
static int vic_cfg_stream_mipi(struct vic_device *vic)
{
	...
	switch(input_fmt->format.code) {
		...
		case MEDIA_BUS_FMT_SRGGB8_1X8:
			...
			vic_reg_writel(vic, MIPI_ALL_WIDTH_4BYTE, ((mipi_cfg->twidth * 8 / 32) + !!(mipi_cfg->twidth * 8 % 32)));
			break;
		...
		case    MEDIA_BUS_FMT_SRGGB10_1X10:
			...
			vic_reg_writel(vic, MIPI_ALL_WIDTH_4BYTE, ((mipi_cfg->twidth * 10 / 32) + !!(mipi_cfg->twidth * 10 % 32)));
			break;
		...
		case    MEDIA_BUS_FMT_SRGGB12_1X12:
			...
			vic_reg_writel(vic, MIPI_ALL_WIDTH_4BYTE, ((mipi_cfg->twidth * 12 / 32) + !!(mipi_cfg->twidth * 12 % 32)));
			break;
		default:
